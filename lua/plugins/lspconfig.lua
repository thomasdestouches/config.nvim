...
return {
    ...
    dependencies = {
        ...
        -- plugins used for completion, annotations and signatures of
        -- Neovim apis
    ...
    config = function()
        ...
        -- helps editors and language tooling communicate in a
        -- standardized fashion.
        --
        -- In general, you have a "server" which is some tool built to
        -- understand a particular language (such as `gopls`, `lua_ls`,
        -- `rust_analyzer`, etc.). These Language Servers
        -- (sometimes called LSP servers, but that's kind of like ATM
        -- Machine) are standalone processes that communicate with some
        ...
        --  - and more!
        --
        -- Thus, Language Servers are external tools that must be
        -- installed separately from Neovim. This is where `mason` and
        -- related plugins come into play.
        --
        ...
        --  buffer. That is to say, every time a new file is opened that
        --  is associated with an lsp (for example, opening `main.rs` is
        --  associated with `rust_analyzer`) this function will be
        --  executed to configure the current buffer
        vim.api.nvim_create_autocmd('LspAttach', {
            ...
            callback = function(event)
                ...
                -- Useful when you're not sure what type a variable is and
                ...
                -- See `:help CursorHold` for information about when this
                -- is executed
                --
                ...
                -- supports them
                --
                -- This may be unwanted, since they displace some of your
                -- code
        ...
        -- we create new capabilities with nvim cmp, and then broadcast
        -- that to the servers.
        ...
        --  - capabilities (table): Override fields in capabilities. Can
        --  be used to disable certain LSP features.
